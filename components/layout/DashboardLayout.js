  ...
  return (
    <div className="relative flex min-h-screen bg-[#f7efe2]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-0 top-0 h-full w-full bg-[radial-gradient(circle_at_top_left,rgba(202,179,122,0.12),transparent_42%),radial-gradient(circle_at_bottom_right,rgba(127,146,91,0.12),transparent_36%)]" />
      </div>
      <Sidebar />
